...
import 'package:e_commerce_app/Presentation/screens/role_based_login/user/user_app_main_screen.dart';
import 'package:e_commerce_app/Presentation/screens/sign_up_screen/sign_up_screen.dart';
  ...
  void logIn() async {
    ...
    if (result == 'Admin') {
      ...
      Navigator.pushReplacement(
        ...
        MaterialPageRoute(
          builder: (_) {
            return UserAppMainScreen(); // Replace with your admin dashboard
          },
        ),
      );
    } else {
